...
async function generate(){if(!companyName.value)return uni.showToast({title:'请先输入企业名称',icon:'none'});loading.value=true;errorMessage.value='';try{result.value=await logoApi.generate({company_name:companyName.value,style_feedback:styleFeedback.value})}catch(error){errorMessage.value=error.message}finally{loading.value=false}}
...
<style scoped>
.logo-layout{display:grid;grid-template-columns:minmax(0,.8fr) minmax(0,1.2fr);gap:28rpx;align-items:start}.page-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:20rpx}.page-heading svg{color:#c75649}.generate-button{width:100%;margin-top:34rpx}.spin{animation:spin .85s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.preview-empty{display:flex;min-height:620rpx;flex-direction:column;align-items:center;justify-content:center;text-align:center}.preview-empty>text:first-of-type{display:block;margin-bottom:10rpx;color:#2b3530;font-size:30rpx;font-weight:700}.preview-loader{margin-bottom:22rpx;color:#16836b}.preview-placeholder{display:flex;width:96rpx;height:96rpx;align-items:center;justify-content:center;margin-bottom:24rpx;border-radius:8px;background:#eef2f0;color:#6d7973}.logo-canvas{display:flex;aspect-ratio:1/1;align-items:center;justify-content:center;overflow:hidden;border:1px solid #dce2df;border-radius:8px;background:#fff}.logo-image{width:100%;height:100%}.result-meta{margin-top:18rpx}.result-title{display:flex;align-items:flex-start;justify-content:space-between;gap:20rpx}.result-title view text:first-child{display:block;font-size:32rpx;font-weight:750}.result-title view text:last-child{display:block;margin-top:7rpx;color:#16836b;font-size:23rpx}.icon-button{display:flex;width:68rpx;height:68rpx;align-items:center;justify-content:center;border:1px solid #d0d9d5;border-radius:6px;background:#fff;color:#486158}.prompt-label{display:block;margin-top:28rpx;color:#77817c;font-size:22rpx}.prompt-text{display:block;margin-top:8rpx;color:#3a4640;font-size:24rpx;line-height:1.7}.download-button{width:100%;margin-top:26rpx}@media(max-width:820px){.logo-layout{display:block}.preview-area{margin-top:28rpx}.preview-empty{min-height:400rpx}.result-wrap{max-width:720rpx;margin:0 auto}}
</style>
